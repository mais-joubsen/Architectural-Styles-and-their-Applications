...
{ 
    ...
    { 	
    	// What we do is bind to rmiregistry, in this case localhost, port 1098. This is the default
    ...
    // This method returns the order from the orderinfo database, corresponding to the id
